...
- The Startup Apps tab (my personal favourite) where you can see all the apps/processes that are found in the Windows Registry and might start up with windows at boot time.
